...
class DbService {
  constructor() {
    ...
    // Construct full table name with database and schema
    this.fullTableName = `[${this.leafCollectionDb}].[${this.schema}].[${this.leafCollectionTable}]`;
  }

  // Helper method to get table name with database and schema
  getTableName() {
  ...
  updateDatabaseConfig(config) {
    ...
    // Reconstruct full table name
    this.fullTableName = `[${this.leafCollectionDb}].[${this.schema}].[${this.leafCollectionTable}]`;
    
    console.log('Database configuration updated:', {
      leafCollectionDb: this.leafCollectionDb,
      leafCollectionTable: this.leafCollectionTable,
      schema: this.schema,
